      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.container}>
        ...
        <View style={styles.hero}>
          ...
          <Text style={styles.heroSubtitle}>
            Centro de Equoterapia e Desenvolvimento
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.bodyText}>
            Promover o desenvolvimento integral de crianças com deficiência por
            meio da equoterapia e de um cuidado humano, acolhedor e
            especializado. Acreditamos que cada criança tem um potencial único
            para crescer, se comunicar e se conectar com o mundo.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.bodyText}>
            ...
            cavalo como instrumento de reabilitação. O movimento tridimensional
            do cavalo estimula o sistema neuromotor, melhora o equilíbrio, a
            postura, a coordenação motora e contribui para o desenvolvimento
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              Linking.openURL('https://maps.google.com/?q=Campina+Verde+MG')
            }
          >
        ...
        <View style={styles.appInfo}>
          ...
          <Text style={styles.appInfoDesc}>
            Desenvolvido para facilitar a comunicação entre família e equipe
            terapêutica, centralizando informações, compromissos e o histórico
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            Feito com ❤️ para famílias que compartilham amor, dedicação e
            esperança.
          </Text>
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { ...(typography.h3 as object), color: colors.text },
  bodyText: {
  ...
  benefitText: { ...(typography.body2 as object), color: colors.text },
  contactRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: spacing.m,
  ...
  contactText: { ...(typography.body1 as object), color: colors.text, flex: 1 },
  appInfo: {

...
const CATEGORIES = [
  { id: 'all', label: 'Todos' },
  {
    id: 'federal',
    label: '🇧🇷 Federal',
    ids: ['bpc', 'isentoipva', 'isetoipi', 'passe', 'aposentadoria'],
  },
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.container}>
        <View style={styles.banner}>
          ...
          <Text style={styles.bannerText}>
            Famílias de crianças com deficiência têm acesso a benefícios
            importantes. Toque em cada item para ver os requisitos.
          </Text>
        </View>
        ...
        >
          {CATEGORIES.map((cat: any) => (
            <TouchableOpacity
              ...
              style={[
                styles.catChip,
                activeCat === cat.id && styles.catChipActive,
              ]}
            ...
            >
              <Text
                style={[
                  styles.catChipText,
                  activeCat === cat.id && styles.catChipTextActive,
                ]}
              >
                {cat.label}
              </Text>
        ...
        {filtered.map((b: any) => {
          ...
          return (
            <TouchableOpacity
              key={b.id}
              style={[styles.card, isOpen && { borderColor: b.color }]}
              onPress={() => toggle(b.id)}
              activeOpacity={0.85}
            >
              <View style={styles.cardRow}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={[styles.cardSub, { color: b.color }]}>
                    {b.subtitle}
                  </Text>
                </View>
                {isOpen ? (
              ...
              {isOpen && (
                <View style={styles.details}>
                  ...
                  >
                    ...
                    <Text style={[styles.linkText, { color: b.color }]}>
                      {b.linkText}
                    </Text>
                  </TouchableOpacity>
                </View>
        ...
        {filtered.length === 0 && (
          <View style={styles.noResults}>
            <Text style={styles.noResultsText}>
              Nenhum benefício encontrado para "{searchQuery}"
            </Text>
          </View>
        )}
        <View style={styles.disclaimer}>
          <Text style={styles.disclaimerText}>
            ⚠️ As informações são de caráter informativo. Consulte um advogado,
            assistente social ou o INSS para orientação específica ao seu caso.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  cardSub: { ...(typography.caption as object), fontWeight: '600' as const, marginTop: 2 },
  details: {
    marginTop: spacing.m,
  ...
  linkText: { ...(typography.body2 as object), fontWeight: '700' as const },
  disclaimer: {
  ...
  disclaimerText: { ...(typography.caption as object), color: '#92400e', lineHeight: 20 },
  searchBar: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: spacing.s,

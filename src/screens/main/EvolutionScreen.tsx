        ...
        <View style={styles.header}>
          <View>
            ...
            <Text style={styles.subtitle}>
              Evolução e registros terapêuticos.
            </Text>
          </View>
          <TouchableOpacity
            ...
            onPress={() =>
              webAlert(
                'ℹ️ Registros de Evolução',
                'Novos registros de evolução são inseridos pela equipe terapêutica (terapeuta ou responsável autorizado) diretamente no sistema.'
              )
            }
          >
          ...
          {!loading && notes.length > 0 ? (
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyText}>
                Os registros de evolução são inseridos pela equipe terapêutica
                após cada sessão.
              </Text>
            </View>
          ) : null}
